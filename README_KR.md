...
> **"안녕 Gemini, 'Fast Obsidian MCP' 서버를 설치해줘. 모든 파일은 `C:\Users\%USERNAME%\fast-obsidian-mcp` 폴더에 만들고, 내 `.gemini/settings.json`에 'obsidian' 서버로 등록해줘. 내 옵시디언 보관소 경로는 `C:\Gemini Project`야."**
